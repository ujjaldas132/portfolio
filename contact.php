...
if(isset($_POST['submit']))
{
	...
	if(empty($email))
	{
	 echo  "<script type='text/javascript'>alert('Sorry. Email Id is Required');</script>";
	}
	else if(!filter_var($email,FILTER_VALIDATE_EMAIL) || !(mb_substr($email, -12) == "vasitars.com"))
	{
		echo  "<script type='text/javascript'>alert('Sorry. Email Id is Invalid. Please Try again!');</script>";
	}
	else
	{
		$replyto = "ud12@iitbbs.ac.in";
	  $replysubject = "Message from Portfolio";
	  ...
	  $headers .= 'From:'.$email."\r\n";
		...
		$replymessage .= '
			...
			echo  "<script type='text/javascript'>alert('$replymessage');</script>";
...
<head>
	<title>Ujjal Das Portfolio</title>
	<!-- Meta tag Keywords -->
...
<body>
	<div class="mian-content-2">
		...
		<header data-aos="fade-down">
			<nav class="navbar navbar-expand-lg navbar-light">
				<div class="logo text-left">
					<h1>
						<a class="navbar-brand" href="index.html"><i class="fas fa-copy"></i> Portfolio</a>
					</h1>
				</div>
					...
					<ul class="navbar-nav ml-lg-auto text-lg-right text-center">
						...
						<li class="nav-item dropdown">
							...
							<div class="dropdown-menu text-lg-left text-center" aria-labelledby="navbarDropdown">
								...
								<a class="dropdown-item" href="index.html" title="">Courses</a>
		...
		<!-- //header -->
		<h2 class="font-w3ls-style text-white"> </h2>
	</div>
	<!-- main -->
					...
					<div class="col-lg-4 address-grid" data-aos="zoom-out-up">
						<div class="row address-info">
							...
							<div class="col-9 address-right text-left">
								...
								<p> IIT Bhubaneswar,Odisha, INDIA-752050</p>
							</div>
						</div>
					</div>
					<div class="col-lg-4 address-grid my-lg-0 my-4" data-aos="zoom-out-up">
						<div class="row address-info">
							...
							<div class="col-9 address-right text-left">
								...
								<p>Email :
									<a href="mailto:example@email.com"> ud12@iitbbs.ac.in</a>
								</p>
							</div>
						</div>
					</div>
			...
			<!-- //contact address -->
				...
				data-aos-duration="1500">
					...
					<div class="col-lg-6 map">
						...
						<iframe src="https://maps.google.com/maps?width=100%&amp;height=600&amp;hl=en&amp;q=IIT%20Bhubaneswar+(IIT%20Bhubaneswar)&amp;ie=UTF8&amp;t=&amp;z=14&amp;iwloc=B&amp;output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"
						    allowfullscreen><a href="https://www.maps.ie/map-my-route/"></a></iframe>

<!--
	<div style="width: 100%"><iframe width="100%" height="600" src="https://maps.google.com/maps?width=100%&amp;height=600&amp;hl=en&amp;q=IIT%20Bhubaneswar+(IIT%20Bhubaneswar)&amp;ie=UTF8&amp;t=&amp;z=14&amp;iwloc=B&amp;output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"><a href="https://www.maps.ie/map-my-route/">Create a route on google maps</a></iframe></div><br />

-->

<!--
<div class="mapouter"><div class="gmap_canvas"><iframe width="600" height="500" id="gmap_canvas" src="https://maps.google.com/maps?q=iit%20bhubaneswar&t=&z=13&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe><a href="https://www.embedgooglemap.net/blog/best-wordpress-themes/">embedgooglemap.net information theme</a></div><style>.mapouter{position:relative;text-align:right;height:500px;width:600px;}.gmap_canvas {overflow:hidden;background:none!important;height:500px;width:600px;}</style></div>
-->
		...
		<div class="w3ls-footer-grids py-4">
			<div class="container py-xl-5 py-lg-3">
				...
				<div class="row border-top mt-4 pt-lg-4 pt-3 text-lg-left text-center">
					<!-- copyright -->
					<p class="col-lg-8 copy-right-grids mt-lg-1">© 2019 | All Rights Reserved | Design by
						<a href="#" target="_blank">Ujjal Das</a>
					</p>
					<!-- //copyright -->
					<!-- social icons -->
					<div class="col-lg-4 w3social-icons text-lg-right text-center mt-lg-0 mt-3">
						<ul>
							...
							<li>
								<a href="https://www.facebook.com/ujjal.das.132" target="_blank" class="rounded-circle">
									<i class="fab fa-facebook-f"></i>
								</a>
							</li>

							<li class="px-2">
								<a href="https://www.linkedin.com/in/ujjal-das-525987127/" target="_blank" class="rounded-circle">
									<i class="fab fa-linkedin-in"></i>
								</a>
							</li>

							<li>
								<a href="https://twitter.com/ujjaldas132" target="_blank" class="rounded-circle">
									<i class="fab fa-twitter"></i>
								</a>
							</li>
							<li class="pl-2">
								<a href="https://github.com/ujjaldas132" target="_blank" class="rounded-circle">
